...
int main()
{
	...
	string text;
	string x = "";
	ifstream fileRead("sample.xml");		//input stream
	...
	writeFile("compressed.dat", a);				//write the ouput vector to .dat file
	vector<int>b;
	b = readFile("compressed.dat");				//read encoded numbers from .dat file to decode
